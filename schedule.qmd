...
While you may be most tempted to use **PNA** (and it does have a nice applied presentation), the content itself jumps around a bit relative to the sequencing of our class, which occaisionally has you reading things ahead of time or before time (or sometimes missing things in proper sequence) so you might find one of the other options more to your liking.
...
You may use any as your primary reference. If you need more depth, consult **STA** or **PNA**. If you want lighter or more intuitive explanations, lean on **MtM**.
